async function enviar() {
    ...
    const respuesta = await fetch("https://api.openai.com/v1/chat/completions", {
        method: "POST",
        headers: {
            "Authorization": "Bearer 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", // 👈 reemplaza con tu API Key
